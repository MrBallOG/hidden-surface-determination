...
export class Matrix4x4 {
    ...
    public matirxInverse(matrix: Matrix4x4): Matrix4x4 {
        const matInv = Matrix4x4.empty();
        matInv.rows[0 * 4 + 0] = matrix.rows[0 * 4 + 0];
        matInv.rows[0 * 4 + 1] = matrix.rows[1 * 4 + 0];
        matInv.rows[0 * 4 + 2] = matrix.rows[2 * 4 + 0];
        matInv.rows[0 * 4 + 3] = 0.0;
        matInv.rows[1 * 4 + 0] = matrix.rows[0 * 4 + 1];
        matInv.rows[1 * 4 + 1] = matrix.rows[1 * 4 + 1];
        matInv.rows[1 * 4 + 2] = matrix.rows[2 * 4 + 1];
        matInv.rows[1 * 4 + 3] = 0.0;
        matInv.rows[2 * 4 + 0] = matrix.rows[0 * 4 + 2];
        matInv.rows[2 * 4 + 1] = matrix.rows[1 * 4 + 2];
        matInv.rows[2 * 4 + 2] = matrix.rows[2 * 4 + 2];
        matInv.rows[2 * 4 + 3] = 0.0;
        matInv.rows[3 * 4 + 0] = -(matrix.rows[3 * 4 + 0] * matInv.rows[0 * 4 + 0] + matrix.rows[3 * 4 + 1] * matInv.rows[1 * 4 + 0] + matrix.rows[3 * 4 + 2] * matInv.rows[2 * 4 + 0]);
        matInv.rows[3 * 4 + 1] = -(matrix.rows[3 * 4 + 0] * matInv.rows[0 * 4 + 1] + matrix.rows[3 * 4 + 1] * matInv.rows[1 * 4 + 1] + matrix.rows[3 * 4 + 2] * matInv.rows[2 * 4 + 1]);
        matInv.rows[3 * 4 + 2] = -(matrix.rows[3 * 4 + 0] * matInv.rows[0 * 4 + 2] + matrix.rows[3 * 4 + 1] * matInv.rows[1 * 4 + 2] + matrix.rows[3 * 4 + 2] * matInv.rows[2 * 4 + 2]);
        matInv.rows[3 * 4 + 3] = 1.0;
        return matInv;
    }
